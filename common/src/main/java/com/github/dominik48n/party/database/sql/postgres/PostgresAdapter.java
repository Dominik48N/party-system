...
public class PostgresAdapter extends SqlAdapter {
    ...
    protected @NotNull ConfigurationStage configurationStage() {
        final String host = PostgresAdapter.super.sqlConfig.hostname();
        final int port = PostgresAdapter.super.sqlConfig.port();
        final String user = PostgresAdapter.super.sqlConfig.username();
        final String password = PostgresAdapter.super.sqlConfig.password();
        final String database = PostgresAdapter.super.sqlConfig.database();
